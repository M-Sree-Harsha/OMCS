...
model Source
 ...
 Modelicaheater.Interfaces.RealInput T_in annotation(
 ...
 Modelicaheater.Interfaces.RealInput P_in annotation(
 ...
 Modelicaheater.Interfaces.RealInput F_in annotation(
 ...
 Modelicaheater.Interfaces.RealInput Xin[Nc] annotation(
 ...
 Modelicaheater.Interfaces.matConn Out(Nc = Nc) annotation(
